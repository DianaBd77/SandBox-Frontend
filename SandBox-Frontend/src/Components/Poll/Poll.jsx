...
const Poll = () => {
  ...
  const getItemData = (id) => {
    const token = localStorage.getItem("token");
    axios
      .get(`http://dianabehshad.xyz/api/item/${id}`, {
        headers: {
          authorization: `Bearer ${token}`,
        },
      })
  ...
  const getVoteResult = (id) => {
    const token = localStorage.getItem("token");
    axios
      .get(`http://dianabehshad.xyz/api/choice/id/${id}`, {
        headers: {
          authorization: `Bearer ${token}`,
        },
      })
  ...
  const insertName = () => {
    ...
    const token = localStorage.getItem("token");
    axios
      .post(`http://dianabehshad.xyz/api/participant`, {
        poll_id: pollID,
        name: name,
      })
      .then((res) => {
  ...
  const insertVote = (id) => {
    ...
    axios
      .post(`http://dianabehshad.xyz/api/choice`, {
        poll_id: pollID,
        participant_id: id,
        item_id: itemID,
      })
